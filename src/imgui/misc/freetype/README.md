...
Build imfont atlases using FreeType instead of stb_truetype (which is the default imfont rasterizer).
...
- *SVG in Open Type* is a standard by Adobe and Mozilla for color OpenType and Open Font Format fonts. It allows imfont creators to embed complete SVG files within a imfont enabling full color and even animations.
- Popular fonts such as [twemoji](https://github.com/13rac1/twemoji-color-imfont) and fonts made with [scfbuild](https://github.com/13rac1/scfbuild) is SVGinOT
