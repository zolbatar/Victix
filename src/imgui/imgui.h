...
struct ImFont
{
    ...
    void RenderCharInternal(ImDrawList *draw_list, float size, const ImVec2 &pos, ImU32 col, ImFontGlyph *glyph) const;
    void RenderCharInternal(ImDrawList *draw_list, float size, const ImVec2 &pos, ImU32 col, const ImFontGlyph *glyph) const;
};
